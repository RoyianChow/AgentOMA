...
| [`10 — Bounded AI`](TASK-10-bounded-ai.md) | Applied AI; synthetic evaluation of pharmacist-reviewed assistance | AI-RX-06 retired; expansion remains blocked and no bounded-AI runtime is active | No PHI, model call, production inference, user-visible clinical recommendation, or autonomous effect. Any future candidate belongs in Task 01's sandbox and needs its own charter and Task 11 review. |
